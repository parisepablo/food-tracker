  ...
  return (
    <>
      ...
      <div
        ref={ref}
        className={cn(
          "fixed z-50 gap-4 bg-card p-6 shadow-2xl transition ease-in-out border-border",
          sideClasses[side],
          className
        )}
        {...props}
      >
        ...
        <button
          onClick={() => onOpenChange(false)}
          className="absolute right-4 top-4 rounded-sm opacity-80 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground"
        >
