...
BEGIN
  ...
  -- Add comment
  COMMENT ON FUNCTION public.handle_new_user_confirmed() IS 'Creates a profile and optionally a household when email is confirmed for the first time, unless the user has a pending household invitation';
